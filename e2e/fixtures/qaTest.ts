...
export async function expectNoRawKeys(page: Page) {
  ...
  expect(body).not.toMatch(/(?:publicExperience|sessionExperience|auth\.(?:forgotPassword|resetPassword|passwordVisibility)|quickMatch|tutorPayouts|runtimeError|pwa)\.[\w.-]+/);
}
