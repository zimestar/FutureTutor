  ...
  return (
    <MarketingShell>
      ...
      <Section className="bg-off-white">
        ...
        <div className="mx-auto mt-12 max-w-3xl rounded-2xl border border-dashed border-border-strong bg-white p-7 text-center"><CircleHelp className="mx-auto size-6 text-slate" aria-hidden="true" /><h2 className="mt-4 text-xl font-extrabold text-navy">{t("general.title")}</h2><p className="mt-2 leading-7 text-text-secondary">{t("general.description")}</p></div>
      </Section>
    </MarketingShell>
  );
}
