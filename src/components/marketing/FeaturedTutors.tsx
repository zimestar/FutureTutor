  ...
  return (
    <Section id="featured-tutors" ariaLabelledby="featured-tutors-heading" className="bg-off-white">
      <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
        ...
        <TrackedCtaButton href="/find-tutors" event="find_tutor_cta_clicked" properties={{ cta_location: "content" }} variant="outline" className="shrink-0">{t("browseAll")}</TrackedCtaButton>
      </div>
